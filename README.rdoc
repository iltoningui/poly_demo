...
The <tt>accepts_nested_attributes_for</tt> does the job - the rest of the code serves two other equally important functions. The first
...
2. Update views/editorials/_form.html.erb (don't forget with_blank_comment in form!)
...
That's it. A proper polymorphic association with a nested form, without a nested resource.
