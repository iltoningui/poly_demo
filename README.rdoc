...
This model has a <tt>content</tt> attribute, which will store the actual comment. The other two attributs,
...
And be able to add posts and comments. Admittedly, this is ugly looking, but that's not our focus here.
...
You now have a polymorphic association, but 1) how do you CRUD (create read update delete) comments belonging to post?
